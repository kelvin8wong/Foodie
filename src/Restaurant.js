    ...
    return (
      <li>
        ...
        <hr></hr>
          ...
          <input className="btn btn-default btn-sm" style={{display:this.props.showFavourites ? 'none' : 'blocl'}} onClick={this.addFavourite} type="submit" value="Add to Favourites"/>
          <input className="btn btn-default btn-sm" style={{display:this.props.showFavourites ? 'block' : 'none'}} onClick={this.delFavourite} type="submit" value="Remove from Favourite"/>
        </div>
      </li>
    );
  }
